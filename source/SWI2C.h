...
#define SWI2C_CLOCK_HIGH() gpio_set(BP_SWI2C_CLK_PORT, BP_SWI2C_CLK_PIN)
#define SWI2C_CLOCK_LOW() gpio_clear(BP_SWI2C_CLK_PORT, BP_SWI2C_CLK_PIN)

#define SWI2C_DATA_HIGH() gpio_set(BP_SWI2C_SDA_PORT, BP_SWI2C_SDA_PIN)
#define SWI2C_DATA_LOW() gpio_clear(BP_SWI2C_SDA_PORT, BP_SWI2C_SDA_PIN)